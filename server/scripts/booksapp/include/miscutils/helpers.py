...
class BooksHelpers(object):
    ...
    def get_correct_genre(genre_code):
        genres = {
            ...
            'дедективы': 'Дедективы',
            'триллеры': 'Триллеры',
            'иронические-дедективы': 'Иронические дедективы',
            'шпионские-дедективы': 'Шпионские дедективы',
            'классические-дедективы': 'Классические дедективы',
            'криминальные-дедективы': 'Криминальные дедективы',
            'полицейские-дедективы': 'Полицейские дедективы',
            'крутой-дедектив': 'Крутой дедектив',
            'исторические-дедективы': 'Исторические дедективы'
        }
        return genre_code

    ...
    render() {
        ...
        return (
            <div className="main-about__panel">
                ...
                <div className="main-about__content">
                    <div className="paragraph">
                        Репозиторий проекта - <a style={{color:'#2b80cf'}} target="_blank" href="https://github.com/dgdagadin87/books">https://github.com/dgdagadin87/books</a>, &nbsp; автор проекта - <a style={{color:'#2b80cf'}} href="mailto:dgdagadin@gmail.com">dgdagadin@gmail.com</a>.
                    </div>
                </div>
            </div>
        );
